...
export function GoogleOAuthSettings({ companyId, onIntegrationChange }: GoogleOAuthSettingsProps) {
 ...
 const getStatusIcon = () => {
  if (!integration) return <XCircle className="h-4 w-4 text-muted" />;
  ...
  <Card>
   ...
   <CardContent className="space-y-4">
    {integration?.config?.user_info && (
     <div className="p-3 bg-badge-success-bg rounded-lg">
      <div className="flex items-center gap-3">
       ...
       <div>
        <p className="font-medium text-badge-success-text">
         {integration.config.user_info.name}
        </p>
        <p className="text-sm text-badge-success-text">
