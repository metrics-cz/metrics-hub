...
export default function IntegrationResultsWidget({
 ...
 if (loading) {
  return (
   <div className={`flex items-center justify-center p-4 ${className}`}>
    ...
    <span className="ml-2 text-sm text-muted">Loading results...</span>
   </div>
  );
 }
 ...
 if (results.length === 0) {
  return (
   <div className={`p-4 bg-base border border-border-light rounded-lg ${className}`}>
    <div className="flex items-center gap-2">
  ...
  return (
   <div className={`p-4 border rounded-lg ${className}`}>
    <div className="flex items-center justify-between">
     <div>
      <h3 className="text-sm font-medium text-primary">Integration Health</h3>
      <p className="text-xs text-muted">{results.length} integrations</p>
     </div>
     <div className="flex items-center gap-2">
      {healthyCount > 0 && (
       <div className="flex items-center gap-1">
