...
export default function InvitationPage() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-base">
        <div className="text-center">
          <p className="text-secondary mb-4">
            Pro zobrazení pozvánky se musíte přihlásit.
          </p>
          <button
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-base">
        <div className="text-center">
          ...
          <p className="text-secondary">Načítám pozvánku...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !invitation) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-base">
        <div className="max-w-md w-full bg-red rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-secondary mb-4">
            {error ||
              "Požadovaná pozvánka neexistuje nebo již byla zpracována."}
          </p>
          <button
  ...
  const canRespond =
    invitation.status === "pending" && !invitation.isExpired && !responding;
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8 text-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">Pozvánka do společnosti</h1>
          ...
          <div className="p-6">
            {/* Company Info */}
            <div className="flex items-center gap-4 mb-6 p-4 bg-base rounded-lg">
              ...
              <div className="text-center">
                <p className="text-secondary mb-4">
                  {invitation.status === "accepted" &&
                    "Tuto pozvánku jste již přijali."}
                  {invitation.status === "rejected" &&
                    "Tuto pozvánku jste odmítli."}
                  {(invitation.status === "expired" || invitation.isExpired) &&
                    "Platnost této pozvánky vypršela."}
                </p>
                <button
                  onClick={() => router.push("/en/companies")}
