...
export default function CreatePluginPage() {
 ...
 return (
  <div className="min-h-screen bg-card text-white">
   {/* Header */}
   <div className="border-b border-border-default bg-elevated">
        ...
        <div key={stepNum} className="flex items-center gap-2">
         ...
         {stepNum < 4 && (
          <div className={`w-8 h-0.5 ${
           getStepStatus(stepNum) === 'completed' ? 'bg-green-600' : 'bg-elevated'
          }`} />
         )}
        </div>
       ))}
   ...
   <div className="max-w-4xl mx-auto px-6 py-8">
    ...
    {step === 1 && (
     <div className="space-y-6">
      <div className="text-center mb-8">
       ...
       <p className="text-muted">Select a starting point for your plugin</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
       {TEMPLATES.map((template) => (
        <div
         key={template.id}
         className={`relative p-6 bg-elevated rounded-xl border-2 cursor-pointer transition-all hover:bg-elevated ${
          ...
          <div>
           ...
           <div className="flex flex-wrap gap-1">
            {template.features.map((feature, index) => (
             <span key={index} className="px-2 py-1 text-xs bg-card text-secondary rounded">
              {feature}
             </span>
            ))}
           </div>
    ...
    {step === 2 && (
     <div className="space-y-6">
      <div className="text-center mb-8">
       ...
       <p className="text-muted">Configure your plugin's basic information</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
       <div>
        ...
        <input
         ...
         className="w-full px-4 py-3 bg-elevated border border-border-default rounded-lg focus:outline-none focus:border-blue-500"
        />
       </div>
       ...
       <div>
        ...
        <input
         ...
         className="w-full px-4 py-3 bg-elevated border border-border-default rounded-lg focus:outline-none focus:border-blue-500"
        />
        <p className="text-xs text-muted mt-1">Used for package.json name and directory</p>
       </div>
       ...
       <div>
        ...
        <textarea
         ...
         rows={3}
         className="w-full px-4 py-3 bg-elevated border border-border-default rounded-lg focus:outline-none focus:border-blue-500 resize-none"
        />
       </div>
          ...
          <button
           ...
           className={`p-3 text-left rounded-lg border transition-all ${
            config.category === category.id
             ? 'border-blue-500 bg-blue-900/10'
             : 'border-border-default bg-elevated hover:border-border-default'
           }`}
          >
    ...
    {step === 3 && (
     <div className="space-y-6">
      <div className="text-center mb-8">
       ...
       <p className="text-muted">Set up directories and permissions</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
       <div>
        ...
        <div className="flex">
         <div className="flex items-center px-3 bg-elevated border border-r-0 border-border-default rounded-l-lg">
         ...
         <input
          ...
          className="flex-1 px-4 py-3 bg-elevated border border-border-default rounded-r-lg focus:outline-none focus:border-blue-500"
         />
        </div>
        <p className="text-xs text-muted mt-1">Where to create the plugin directory</p>
       </div>
       ...
       <div>
        ...
        <div className="space-y-2">
         {PERMISSIONS.map((permission) => (
          <label key={permission.id} className="flex items-start gap-3 p-3 bg-elevated rounded-lg cursor-pointer">
           <input
            type="checkbox"
           ...
           <div>
            ...
            <div className="text-sm text-muted">{permission.description}</div>
           </div>
          </label>
         ))}
        </div>
    ...
    {step === 4 && (
     <div className="space-y-6">
      <div className="text-center mb-8">
       ...
       <p className="text-muted">Review your plugin configuration before creating</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
       <div className="bg-elevated rounded-lg p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
         <div>
          <label className="text-sm text-muted">Plugin Name</label>
         ...
         <div>
          <label className="text-sm text-muted">Directory</label>
    ...
    {/* Navigation */}
    <div className="flex justify-between pt-8 border-t border-border-default mt-8">
     <button
     ...
     <div className="flex gap-3">
      {step < 4 ? (
       <button
        ...
        disabled={!canProceed()}
        className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-elevated disabled:cursor-not-allowed rounded-lg font-medium transition-colors"
       >
        Next
       ...
       <button
        ...
        disabled={creating}
        className="flex items-center gap-2 px-6 py-2 bg-green-600 hover:bg-green-700 disabled:bg-elevated disabled:cursor-not-allowed rounded-lg font-medium transition-colors"
       >
        {creating ? (
         <>
