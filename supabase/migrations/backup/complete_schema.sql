...
--
-- Name: company_invitation_role; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: company_invitation_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: company_users company_id_user_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: companies_billing_email_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: company_invitations_companyId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: company_invitations_email_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: company_invitations_invitedBy_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: company_invitations_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: company_invitations_userId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: companies companies_owner_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: company_invitations company_invitations_invitedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: company_invitations company_invitations_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: company_users company_users_company_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: objects Authenticated users can upload own avatar; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can upload own avatar" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'avatars'::text) AND (auth.uid() IS NOT NULL) AND (storage.filename(name) = concat('avatars/', auth.uid(), '/', auth.uid())) AND (owner = auth.uid())));


--
-- Name: objects User can list their own avatar; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "User can list their own avatar" ON storage.objects FOR SELECT TO authenticated USING ((bucket_id = 'avatars'::text));
...
CREATE POLICY "Users can delete their own files" ON storage.objects FOR DELETE TO authenticated USING (((auth.uid())::text = owner_id));


--
-- Name: objects Users can insert their own files; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can insert their own files" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((auth.uid())::text = owner_id));
...
CREATE POLICY "Users can update their own files" ON storage.objects FOR UPDATE TO authenticated USING (((auth.uid())::text = owner_id)) WITH CHECK (((auth.uid())::text = owner_id));
...
CREATE POLICY "Users can view their own files" ON storage.objects FOR SELECT TO authenticated USING (((auth.uid())::text = owner_id));
